...
// Control table address
  ...
  #define MINIMUM_POSITION_LIMIT      1300  // Refer to the Minimum Position Limit of product eManual
  #define MAXIMUM_POSITION_LIMIT      3000  // Refer to the Maximum Position Limit of product eManual
...
int main() {
  ...
  int Minimum_position_limit = 2000;
  int Maximum_position_limit = 2500;
  ...
  while(1) {
    ...
    dxl_goal_position[0] = {2000}; // min
    dxl_goal_position[1] = {3500}; // max
    // if (g ==0)
    // {
    //   dxl_goal_position[0] = {2000}; // min
    //   dxl_goal_position[1] = {2500}; // max
    //   g++;
    // }
    // else if (g ==1)
    // {
    //   dxl_goal_position[0] = {2000}; // min
    //   dxl_goal_position[1] = {3000}; // max
    //   g++;
    // }
    // else if (g ==2){
    //   dxl_goal_position[0] = {1500}; // min
    //   dxl_goal_position[1] = {2500}; // max
